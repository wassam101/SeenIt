...
export async function LandingPage() {
  ...
  return (
    <div className="grid md:grid-cols-2 md:min-h-[880px]">
      <div className="relative bg-teal text-white px-6 py-12 md:py-16 flex flex-col items-center md:items-start justify-center text-center md:text-left overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="font-display text-lg text-white/80 mt-4 max-w-sm mx-auto md:mx-0">
      ...
      <div className="bg-paper px-6 py-12 md:py-16 flex flex-col items-center justify-center border-t md:border-t-0 md:border-l border-evidence">
        <div className="w-full max-w-xs text-center">
          ...
          <p className="font-sans text-sm text-slate mb-6">Get started</p>
          <Link
            href="/signup"
            className="block font-sans text-[15px] font-bold px-4 py-2.5 bg-teal text-white hover:bg-signal transition-colors rounded-full"
          >
            Sign up
          </Link>
          <p className="font-sans text-sm text-slate mt-5">
