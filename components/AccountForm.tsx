...
export function AccountForm({ initial, userId }: { initial: Profile; userId: string }) {
  ...
  return (
    <form action={handleSubmit} className="flex flex-col gap-4">
      ...
      {saved && <p className="font-mono text-xs text-teal">Saved.</p>}

      <div className="flex items-center gap-3">
        <Avatar name={initial.display_name ?? '?'} avatarUrl={avatarUrl} size={56} />
        <label className="font-mono text-xs uppercase tracking-wider text-teal hover:text-signal transition-colors cursor-pointer">
      ...
      <div className="flex gap-3">
        <label className="block flex-1">
          <span className="block font-mono text-[11px] uppercase tracking-wider text-slate mb-1">First name</span>
          <input
            name="firstName"
        ...
        <label className="block flex-1">
          <span className="block font-mono text-[11px] uppercase tracking-wider text-slate mb-1">Last name</span>
          <input
            name="lastName"
      ...
      <label className="block">
        <span className="block font-mono text-[11px] uppercase tracking-wider text-slate mb-1">Date of birth</span>
        <input
          name="dateOfBirth"
          type="date"
      ...
      <label className="block">
        <span className="block font-mono text-[11px] uppercase tracking-wider text-slate mb-1">Bio</span>
        <textarea
          name="bio"
          rows={3}
